package com.example.user.trendy.CcAvenue;
...
public class InitialActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        OrderDetailModel orderDetailModel=new OrderDetailModel(emailstring,totalamount,firstname,lastname,bfirstname,blastname,address1,city,state,country,zip,phone,b_address1,b_city,b_state,b_country,b_zip, product_varientid,product_qty);
