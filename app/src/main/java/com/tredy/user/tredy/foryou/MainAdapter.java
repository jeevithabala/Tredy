...
import com.tredy.user.tredy.foryou.groceryhome.GroceryHomeAdapter;
import com.tredy.user.tredy.foryou.newarrivalrecycler.NewMainAdapter;
import com.tredy.user.tredy.foryou.topselling.TopSellingAdapter;
import com.tredy.user.tredy.groceries.Groceries;
import com.tredy.user.tredy.R;

import java.util.ArrayList;
import static com.tredy.user.tredy.foryou.ForYou.getGroceryHomeModels;
import static com.tredy.user.tredy.foryou.ForYou.getNewArrival;
import static com.tredy.user.tredy.foryou.ForYou.getTopSellingCollection;
