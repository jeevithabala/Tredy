package com.tredy.user.tredy.utility;
...
public class AvenuesParams {
    ...
    public static final String BILLING_MOBILENUMBER = "billing_tel";
    ...
    public static final String DELIVERY_MOBILENUMBER = "delivery_tel";
