package com.tredy.user.tredy.account.orders;
...
import com.tredy.user.tredy.account.orderList.OrderList;

import com.tredy.user.tredy.callback.FragmentRecyclerViewClick;
import com.tredy.user.tredy.R;
import com.tredy.user.tredy.databinding.OrderAdapterBinding;
