...
import com.tredy.user.tredy.utility.Constants;
import com.tredy.user.tredy.utility.LoadingDialog;
import com.tredy.user.tredy.utility.RSAUtility;
...
//                items.put("variant_id", "5823671107611");
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, com.tredy.user.tredy.util.Constants.postcreateorder, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
...
//            jsonBody.put("note_attributes", note);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, com.tredy.user.tredy.util.Constants.createabandoned, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Log.i("VOLLEY", response);
                    try {
